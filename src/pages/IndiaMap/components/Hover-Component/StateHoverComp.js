...
const StateHoverComp = ({ data, kutchData }) => {
  console.log(kutchData, "kutchData");
  return (
    <Box>
      {
        kutchData?.statusObj?.length > 0 ? (
          <div style={{ width: "185px", height: "180px" }}>
            <List sx={{ marginTop: "5px", marginBottom:"5px" }}>
              <ListItem sx={{ height: "3px", padding: "0px", paddingBottom: "15px" }}>
                <p style={{ fontSize: "11px" }}>No. Of Areas : {data?.noOfArea}</p>
              </ListItem>
              <ListItem sx={{ height: "3px", padding: "0px", paddingBottom: "15px" }}>
            ...
            <Typography variant="body2">GJ kutch</Typography>
            <Divider sx={{ borderColor: "#000" }} />
            <List sx={{ marginTop: "5px"}}>
              <ListItem sx={{ height: "3px", padding: "0px", paddingBottom: "15px" }}>
                <p style={{ fontSize: "11px" }}>No. Of Areas : {kutchData?.noOfArea}</p>
              </ListItem>
              <ListItem sx={{ height: "3px", padding: "0px", paddingBottom: "15px" }}>
                <p style={{ fontSize: "11px" }}>No. Of Sites : {kutchData?.noOfSite}</p>
              </ListItem>
              <ListItem sx={{ height: "3px", padding: "0px", paddingBottom: "15px" }}>
                <p style={{ fontSize: "11px" }}>WTG : {kutchData?.noOfWtg}</p>
              </ListItem>
              <ListItem
                sx={{
                  height: "3px",
              ...
              >
                ...
                >
                  <Box sx={{ display: "flex", flexDirection: "row" }}>
                    <div style={{ paddingRight: "10px" }}>
                      <span className="bg-suzlon status-circle"></span>
                      <div>{kutchData?.statusObj[0]?.statusValue}</div>
                    </div>
                    <div style={{ paddingRight: "10px" }}>
                      <span className="bg-green status-circle"></span>
                      <div>{kutchData?.statusObj[1]?.statusValue}</div>
                    </div>
                    <div style={{ paddingRight: "10px" }}>
                      <span className="bg-red status-circle"></span>
                      <div>{kutchData?.statusObj[2]?.statusValue}</div>
                    </div>
                    <div style={{ paddingRight: "10px" }}>
                      <span className="bg-blue status-circle"></span>
                      <div>{kutchData?.statusObj[3]?.statusValue}</div>
                    </div>
                    <div style={{ paddingRight: "10px" }}>
                      <span className="bg-blue-fent status-circle"></span>
                      <div>{kutchData?.statusObj[4]?.statusValue}</div>
                    </div>
                    <div style={{ paddingRight: "10px" }}>
                      <span className="bg-yellow status-circle"></span>
                      <div>{kutchData?.statusObj[5]?.statusValue}</div>
                    </div>
                  </Box>
                </Box>
              </ListItem>
          ...
          <div style={{ width: "185px", height: "75px" }}>
            <List sx={{ marginTop: "5px" }}>
              <ListItem sx={{ height: "3px", padding: "0px", paddingBottom: "15px" }}>
                <p style={{ fontSize: "11px" }}>No. Of Areas : {data?.noOfArea}</p>
              </ListItem>
