import {
  ...
  import { GET_KPI_BOXES,REQUEST_CALL,GET_CONSMPTION_BY_PLANT_YEAR,COMPARE_CONSUMPTION_QUANTITY,CONSUMPTION_AMOUNT_FOR_LAST_THREE,CONSUMPTION_AMOUNT_FOR_CURRENCY,TOP10_CONSUMPTION_VALUE,GET_CONSUMPTION,GET_COLUMN_CONFIG,GET_CONSUMPTION_QUARTER} from "types/actions/Scm/consumption/index";
  ...
  //Kpi boxes api for titles
   export const getKPI_Tiles = () => {
    ...
    return (dispatch) => {
        ...
        dispatch(setLoader())
      getApiCall(
        `${process.env.REACT_APP_SCM_PORT}/api/SCM/getConsumptionKpi?reportType=KPIBoxes`
      )
        .then((response) => {
  ...
  export const getTotalConsumptionForYear = () => {
    ...
    return (dispatch) => {
        ...
        dispatch(setLoader())
      getApiCall(
        `${process.env.REACT_APP_SCM_PORT}/api/SCM/getConsumptionKpi?reportType=TotalConsumptionForYear`
      )
        .then((response) => {
  ...
  export const getCompareConsumptionQuantity = () => {
    ...
    return (dispatch) => {
        ...
        dispatch(setLoader())
      getApiCall(
        `${process.env.REACT_APP_SCM_PORT}/api/SCM/getConsumptionKpi?reportType=CompareConsumptionQuantity`
      )
        .then((response) => {
   ...
   export const getConsumptionAmountForLastThree = () => {
    ...
    return (dispatch) => {
        ...
        dispatch(setLoader())
      getApiCall(
        `${process.env.REACT_APP_SCM_PORT}/api/SCM/getConsumptionKpi?reportType=ConsumptionAmountForLastThree`
      )
        .then((response) => {
  ...
  export const getConsumptionAmountForCurrentFy = () => {
    ...
    return (dispatch) => {
        ...
        dispatch(setLoader())
      getApiCall(
        `${process.env.REACT_APP_SCM_PORT}/api/SCM/getConsumptionKpi?reportType=ConsumptionAmountForCurrentFy`
      )
        .then((response) => {
  ...
  export const getTop10ConsumptionValue = () => {
    ...
    return (dispatch) => {
        ...
        dispatch(setLoader())
      getApiCall(
        `${process.env.REACT_APP_SCM_PORT}/api/SCM/getConsumptionKpi?reportType=Top10ConsumptionValue`
      )
        .then((response) => {
  ...
  export const getConsumption = () => {
    ...
    return (dispatch) => {
        ...
        dispatch(setLoader())
      getApiCall(
        `${process.env.REACT_APP_SCM_PORT}/api/SCM/getConsumption?pageNumber=1&pageSize=1000&JsonOutput=true`
      )
        .then((response) => {
  ...
  export const getColumnConfigurations = () => {
    ...
    return (dispatch) => {
        ...
        dispatch(setLoader())
      getApiCall(
        `${process.env.REACT_APP_SCM_PORT}/api/SCM/GetColumnConfigurations?template=Consumption`
      )
          .then((response) => {
  ...
  export const getConsumptionForQuarter = () => {
    ...
    return (dispatch) => {
        ...
        dispatch(setLoader())
      getApiCall(
        `${process.env.REACT_APP_SCM_PORT}/api/SCM/getConsumptionKpi?reportType=TotalConsumptionForQuarter`
      )
          .then((response) => {
