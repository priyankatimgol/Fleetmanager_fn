...
import { LanguageProps } from "../@uikit/core/AppLngSwitcher/data";
...
interface AdminERPPalette extends Palette {
  background: {
    paper: string;
    default: string;
  };
...
export interface AdminERPTheme extends Theme {
  direction: Direction;
  cardRadius: number;
  palette: AdminERPPalette;
  status: {
    danger: string;
  };
  divider: string;
